var rrweb = (function (ee) {
  ...
  function cr(t, e) {
    ...
    for (var o = []; r(lr), !(n >= e.length); ) {
      var a = r(ar);
      if (a.slice(-1) === ",")
        (a = Be(t, a.substring(0, a.length - 1))), o.push(a);
      else {
        var s = "";
        a = Be(t, a);
        for (var i = !1; ; ) {
  ...
  function Ot(t, e, n, r) {
    return n === "src" ||
      (n === "href" && r && !(e === "use" && r[0] === "#")) ||
      (n === "xlink:href" && r && r[0] !== "#") ||
      (n === "background" && r && (e === "table" || e === "td" || e === "th"))
      ? Be(t, r)
      : n === "srcset" && r
      ? cr(t, r)
      : n === "style" && r
  ...
  function mr(t, e) {
    var n = e.doc,
      ...
      S = e.recordCanvas,
      f = e.keepIframeSrcFn,
      y = e.newlyAddedElement,
      g = y === void 0 ? !1 : y,
      E = fr(n, r);
    switch (t.nodeType) {
      case t.DOCUMENT_NODE:
        return t.compatMode !== "CSS1Compat"
          ? { type: D.Document, childNodes: [], compatMode: t.compatMode }
  ...
  function yr(t, e) {
    var n,
      ...
      a = e.maskTextFn,
      s = e.rootId,
      i = t.parentNode && t.parentNode.tagName,
      l = t.textContent,
      c = i === "STYLE" ? !0 : void 0,
      u = i === "SCRIPT" ? !0 : void 0;
    if (c && l) {
    ...
    return (
      ...
      !c && !u && l && Lt(t, r, o) && (l = a ? a(l) : l.replace(/[\S]/g, "*")),
      { type: D.Text, textContent: l || "", isStyle: c, rootId: s }
    );
  }
  function gr(t, e) {
    for (
    ...
    if (y === "link" && a) {
      var F = Array.from(n.styleSheets).find(function (v) {
        ...
        _ = null;
      F && (_ = Je(F)),
        _ && (delete g.rel, delete g.href, (g._cssText = Ve(_, F.href)));
    }
    if (
      y === "style" &&
      t.sheet &&
    ...
    if (
      (y === "option" &&
        (t.selected && !i.select ? (g.selected = !0) : delete g.selected),
      y === "canvas" && h)
    ) {
      if (t.__context === "2d")
        Jn(t) || (g.rr_dataURL = t.toDataURL(u.type, u.quality));
      else if (!("__context" in t)) {
        var q = t.toDataURL(u.type, u.quality),
    ...
    if (y === "img" && d) {
      ...
      var H = function () {
        try {
          (we.width = $.naturalWidth),
            (we.height = $.naturalHeight),
            xt.drawImage($, 0, 0),
            (g.rr_dataURL = we.toDataURL(u.type, u.quality));
        } catch (v) {
          console.warn(
            "Cannot inline img src=".concat($.currentSrc, "! Error: ").concat(v)
          );
        }
  ...
  function Ee(t, e) {
    var n = e.doc,
      ...
      F = e.onSerialize,
      _ = e.onIframeLoad,
      J = e.iframeLoadTimeout,
      Y = J === void 0 ? 5e3 : J,
      q = e.onStylesheetLoad,
      z = e.stylesheetLoadTimeout,
      X = z === void 0 ? 5e3 : z,
      $ = e.keepIframeSrcFn,
      Z =
        $ === void 0
    ...
    if ((T.type === D.Document || T.type === D.Element) && W) {
      ...
      if (Tt(t) && t.shadowRoot)
        for (
          var ue = 0, A = Array.from(t.shadowRoot.childNodes);
          ue < A.length;
          ue++
        ) {
          var ae = A[ue],
    ...
    return (
      t.parentNode && Oe(t.parentNode) && Le(t.parentNode) && (T.isShadow = !0),
      T.type === D.Element &&
        T.tagName === "iframe" &&
        hr(
          t,
...
`);
    ...
    function c() {
      ...
      return {
        type: "stylesheet",
        stylesheet: { source: e.source, rules: w, parsingErrors: i },
      };
    }
    function u() {
      return p(/^{\s*/);
    ...
    function h() {
      var w,
        v = [];
      for (m(), b(v); t.length && t.charAt(0) !== "}" && (w = L() || te()); )
        w !== !1 && (v.push(w), b(v));
      return v;
    }
    function p(w) {
    ...
    function y() {
      ...
      if (v) {
        ...
        var T = p(/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^\)]*?\)|[^};])+)/),
          W = w({
            type: "declaration",
            property: M.replace(At, ""),
            value: T ? he(T[0]).replace(At, "") : "",
          });
        return p(/^[;\s]*/), W;
      }
    }
    ...
    function E() {
      for (
        ...
        v.push(w[1]), p(/^,\s*/);
      if (v.length)
        return M({ type: "keyframe", values: v, declarations: g() });
    }
    function k() {
      var w = a(),
        v = p(/^@([-\w]+)?keyframes\s*/);
      if (v) {
        ...
        return d()
          ? w({ type: "keyframes", name: T, vendor: M, keyframes: ne })
          : l("@keyframes missing '}'");
      }
    }
    function x() {
      ...
      if (v) {
        ...
        var T = b().concat(h());
        return d()
          ? w({ type: "supports", supports: M, rules: T })
          : l("@supports missing '}'");
      }
    }
    function F() {
    ...
    function _() {
      ...
      if (v) {
        ...
        var T = b().concat(h());
        return d()
          ? w({ type: "media", media: M, rules: T })
          : l("@media missing '}'");
      }
    }
    function J() {
      var w = a(),
        v = p(/^@custom-media\s+(--[^\s]+)\s*([^{;]+);/);
      if (v)
        return w({ type: "custom-media", name: he(v[1]), media: he(v[2]) });
    }
    function Y() {
      var w = a(),
        v = p(/^@page */);
      if (v) {
        ...
        return d()
          ? w({ type: "page", selectors: M, declarations: T })
          : l("@page missing '}'");
      }
    }
    function q() {
      ...
      if (v) {
        ...
        var W = b().concat(h());
        return d()
          ? w({ type: "document", document: T, vendor: M, rules: W })
          : l("@document missing '}'");
      }
    }
    function z() {
    ...
    function te() {
      var w = a(),
        v = f();
      return v
        ? (b(), w({ type: "rule", selectors: v, declarations: g() }))
        : l("selector missing");
    }
    return nt(c());
  }
  ...
  function Pt(t, e) {
    ...
    var o = [];
    if (
      (r.stylesheet.rules.forEach(function (i) {
        "selectors" in i &&
          (i.selectors || []).forEach(function (l) {
            Ft.test(l) && o.push(l);
          });
      }),
      o.length === 0)
    ...
    switch (t.type) {
      ...
      case D.Element: {
        var a = wr(t),
          s;
        t.isSVG
          ? (s = n.createElementNS("http://www.w3.org/2000/svg", a))
          : (s = n.createElement(a));
        var i = {};
        ...
        var S = function (y) {
          ...
          if (a === "canvas" && y === "rr_dataURL") {
            ...
            var k = s;
            k.currentSrc.startsWith("data:") ||
              (k.setAttribute("rrweb-original-src", t.attributes.src),
              (k.src = g.toString()));
          }
          if (y === "rr_width") s.style.width = g.toString();
          else if (y === "rr_height") s.style.height = g.toString();
          else if (y === "rr_mediaCurrentTime" && typeof g == "number")
            s.currentTime = g;
      ...
      case D.Text:
        return n.createTextNode(
          t.isStyle && r ? Pt(t.textContent, o) : t.textContent
        );
      case D.CDATA:
  ...
  function _e(t, e) {
    var n = e.doc,
      ...
      l = e.afterAppend,
      c = e.cache,
      u = Cr(t, { doc: n, hackCss: i, cache: c });
    if (!u) return null;
    if (
      ...
      t.type === D.Document &&
        ...
        t.compatMode === "BackCompat" &&
          t.childNodes &&
          t.childNodes[0].type !== D.DocumentType &&
          (t.childNodes[0].type === D.Element &&
        ...
        (u = n)),
      r.add(u, t),
      (t.type === D.Document || t.type === D.Element) && !a)
    )
      for (var d = 0, h = t.childNodes; d < h.length; d++) {
        ...
        p.isShadow && Tt(u) && u.shadowRoot
          ? u.shadowRoot.appendChild(m)
          : u.appendChild(m),
          l && l(m, p.id);
      }
    return u;
...
or you can use record.mirror to access the mirror instance during recording.`;
  ...
  function Ce(t, e, n = {}) {
    ...
    return function (...a) {
      ...
      const i = e - (s - o),
        l = this;
      i <= 0 || i > e
        ? (r && (clearTimeout(r), (r = null)), (o = s), t.apply(l, a))
        : !r &&
          n.trailing !== !1 &&
          (r = setTimeout(() => {
        ...
        (this.emit = () => {
          ...
          const e = [],
            ...
            o = (i) => {
              var l, c, u, d;
              let h = null;
              ((c = (l = i.getRootNode) == null ? void 0 : l.call(i)) == null
                ? void 0
                : c.nodeType) === Node.DOCUMENT_FRAGMENT_NODE &&
                i.getRootNode().host &&
                (h = i.getRootNode().host);
              let p = h;
              for (
                ;
                ((d = (u = p?.getRootNode) == null ? void 0 : u.call(p)) == null
                  ? void 0
                  : d.nodeType) === Node.DOCUMENT_FRAGMENT_NODE &&
                p.getRootNode().host;

              )
                p = p.getRootNode().host;
              const m = !this.doc.contains(i) && (!p || !this.doc.contains(p));
              if (!i.parentNode || m) return;
              const b = Oe(i.parentNode)
                  ? this.mirror.getId(h)
              ...
              const f = Ee(i, {
                ...
                onSerialize: (y) => {
                  Ie(y, this.mirror) && this.iframeManager.addIframe(y),
                    ct(y, this.mirror) &&
                      this.stylesheetManager.trackLinkElement(y),
                    ve(i) &&
                ...
                onIframeLoad: (y, g) => {
                  this.iframeManager.attachIframe(y, g),
                    this.shadowDomManager.observeAttachShadow(y);
                },
          ...
          for (const i of Array.from(this.movedSet.values()))
            (jt(this.removes, i, this.mirror) &&
              !this.movedSet.has(i.parentNode)) ||
              o(i);
          for (const i of Array.from(this.addedSet.values()))
            (!Ht(this.droppedSet, i) && !jt(this.removes, i, this.mirror)) ||
            Ht(this.movedSet, i)
              ? o(i)
              : this.droppedSet.add(i);
          let a = null;
          for (; n.length; ) {
            let i = null;
            if (a) {
          ...
          const s = {
            texts: this.texts
              .map((i) => ({ id: this.mirror.getId(i.node), value: i.value }))
            ...
            switch (e.type) {
              case "characterData": {
                ...
                !Q(e.target, this.blockClass, this.blockSelector, !1) &&
                  ...
                  this.texts.push({
                    value:
                      Lt(e.target, this.maskTextClass, this.maskTextSelector) &&
                      n
                        ? this.maskTextFn
                          ? this.maskTextFn(n)
                          : n.replace(/[\S]/g, "*")
              ...
              case "attributes": {
                ...
                if (
                  ...
                  if (!n.contentDocument) e.attributeName = "rr_src";
                  else return;
                if (
                  (o ||
                  ...
                  e.oldValue && a.setAttribute("style", e.oldValue),
                    (o.attributes.style === void 0 ||
                      o.attributes.style === null) &&
                      (o.attributes.style = {});
                  const s = o.attributes.style;
                  for (const i of Array.from(n.style)) {
                    const l = n.style.getPropertyValue(i),
                      c = n.style.getPropertyPriority(i);
                    (l !== a.style.getPropertyValue(i) ||
                      c !== a.style.getPropertyPriority(i)) &&
                      (c === "" ? (s[i] = l) : (s[i] = [l, c]));
                  }
                  for (const i of Array.from(a.style))
                    n.style.getPropertyValue(i) === "" && (s[i] = !1);
                } else
                  o.attributes[e.attributeName] = Ot(
                    this.doc,
                    n.tagName,
                    e.attributeName,
                    r
                ...
                e.addedNodes.forEach((n) => this.genAdds(n, e.target)),
                  e.removedNodes.forEach((n) => {
                    ...
                    Q(e.target, this.blockClass, this.blockSelector, !1) ||
                      ...
                      !$t(n, this.mirror) ||
                      (this.addedSet.has(n)
                        ? (pt(this.addedSet, n), this.droppedSet.add(n))
                        : (this.addedSet.has(e.target) && r === -1) ||
                          st(e.target, this.mirror) ||
                          (this.movedSet.has(n) && this.movedMap[Gt(r, o)]
                            ? pt(this.movedSet, n)
                            : this.removes.push({
                                parentId: o,
                                id: r,
                                isShadow:
                                  Oe(e.target) && Le(e.target) ? !0 : void 0,
                              })),
        ...
        (this.genAdds = (e, n) => {
          if (this.mirror.hasNode(e)) {
            ...
            n && this.mirror.hasNode(n) && (r = this.mirror.getId(n)),
              r &&
                r !== -1 &&
                (this.movedMap[Gt(this.mirror.getId(e), r)] = !0);
  ...
  var xr = Object.defineProperty,
    ...
    Fr = (t, e) => Or(t, Lr(e));
  const Se = [],
    Qt = typeof CSSGroupingRule < "u",
    Jt = typeof CSSMediaRule < "u",
    qt = typeof CSSSupportsRule < "u",
  ...
  function Pr({ mousemoveCb: t, sampling: e, doc: n, mirror: r }) {
    ...
    const l = Ce((d) => {
      ...
      c = Ce(
        (d) => {
          const h = Pe(d),
            { clientX: p, clientY: m } = it(d) ? d.changedTouches[0] : d;
          i || (i = Date.now()),
            s.push({ x: p, y: m, id: r.getId(h), timeOffset: Date.now() - i }),
            l(
      ...
      u = [K("mousemove", c, n), K("touchmove", c, n), K("drag", c, n)];
    return () => {
      u.forEach((d) => d());
    };
  }
  function Wr({
    ...
    return (
      Object.keys(j)
        .filter(
          (c) =>
            Number.isNaN(Number(c)) && !c.endsWith("_Departed") && s[c] !== !1
        )
        .forEach((c) => {
  ...
  const Ur = ["INPUT", "TEXTAREA", "SELECT"],
    on = new WeakMap();
  function Vr({
    inputCb: t,
    doc: e,
    ...
    function u(S) {
      ...
      const y = S.isTrusted;
      if (
        (f && f.tagName === "OPTION" && (f = f.parentElement),
        !f || !f.tagName || Ur.indexOf(f.tagName) < 0 || Q(f, r, o, !0))
      )
        return;
      const g = f.type;
      ...
      g === "radio" &&
        x &&
        k &&
        e.querySelectorAll(`input[type="radio"][name="${x}"]`).forEach((F) => {
          F !== f &&
            d(F, rn({ text: F.value, isChecked: !k, userTriggered: !1 }, c));
        });
    }
    function d(S, f) {
      const y = on.get(S);
    ...
    const h = (l.input === "last" ? ["change"] : ["input", "change"]).map((S) =>
        K(S, u, e)
      ),
      p = e.defaultView;
    if (!p)
    ...
    const m = p.Object.getOwnPropertyDescriptor(
  ...
  function ze(t) {
    ...
    function n(r, o) {
      if (
        (Qt && r.parentRule instanceof CSSGroupingRule) ||
        (Jt && r.parentRule instanceof CSSMediaRule) ||
        (qt && r.parentRule instanceof CSSSupportsRule) ||
        (en && r.parentRule instanceof CSSConditionRule)
      ) {
  ...
  function Br(
    ...
    r.CSSStyleSheet.prototype.insertRule = function (u, d) {
      ...
      return (
        ((h && h !== -1) || (p && p !== -1)) &&
          t({ id: h, styleId: p, adds: [{ rule: u, index: d }] }),
        o.apply(this, [u, d])
      );
    };
    ...
    r.CSSStyleSheet.prototype.deleteRule = function (u) {
      ...
      return (
        ((d && d !== -1) || (h && h !== -1)) &&
          t({ id: d, styleId: h, removes: [{ index: u }] }),
        a.apply(this, [u])
      );
    };
    let s;
    ...
    r.CSSStyleSheet.prototype.replaceSync &&
      ...
      (r.CSSStyleSheet.prototype.replaceSync = function (u) {
        ...
        return (
          ((d && d !== -1) || (h && h !== -1)) &&
            t({ id: d, styleId: h, replaceSync: u }),
          i.apply(this, [u])
        );
      }));
    const l = {};
    Qt
      ...
      : (Jt && (l.CSSMediaRule = r.CSSMediaRule),
        en && (l.CSSConditionRule = r.CSSConditionRule),
        qt && (l.CSSSupportsRule = r.CSSSupportsRule));
    const c = {};
    return (
  ...
  function Gr(
    ...
    return (
      (o.CSSStyleDeclaration.prototype.removeProperty = function (i) {
        var l;
        if (n.has(i)) return s.apply(this, [i]);
        const { id: c, styleId: u } = fe(
          (l = this.parentRule) == null ? void 0 : l.parentStyleSheet,
          e,
          r.styleMirror
        );
        return (
  ...
  function jr({
    ...
    const a = (i) =>
      ...
      s = [
        K("play", a(me.Play)),
        K("pause", a(me.Pause)),
        K("seeked", a(me.Seeked)),
        K("volumechange", a(me.VolumeChange)),
        K("ratechange", a(me.RateChange)),
      ];
    return () => {
      s.forEach((i) => i());
    };
  ...
  class Zr {
    constructor(e) {
      (this.iframes = new WeakMap()),
        ...
        (this.crossOriginIframeMirror = new an(Rt)),
  ...
  class to {
    constructor(e) {
      ...
      this.restorePatches.push(
        ge(Element.prototype, "attachShadow", function (r) {
          return function (o) {
    ...
    addShadowRoot(e, n) {
      !Le(e) ||
        this.shadowDoms.has(e) ||
        (this.shadowDoms.add(e),
        tn(
          dn(un({}, this.bypassOptions), {
            doc: n,
    ...
    observeAttachShadow(e) {
      if (e.contentWindow) {
        ...
        this.restorePatches.push(
          ge(
            e.contentWindow.HTMLElement.prototype,
            "attachShadow",
            function (r) {
              return function (o) {
                const a = r.call(this, o);
                return (
                  this.shadowRoot &&
                    n.addShadowRoot(this.shadowRoot, e.contentDocument),
                  a
                );
              };
            }
  ...
  for (
    var Me = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
      We = typeof Uint8Array > "u" ? [] : new Uint8Array(256),
      He = 0;
    He < Me.length;
    He++
  )
    We[Me.charCodeAt(He)] = He;
  var no = function (t) {
      ...
      for (n = 0; n < r; n += 3)
        (o += Me[e[n] >> 2]),
          (o += Me[((e[n] & 3) << 4) | (e[n + 1] >> 4)]),
          (o += Me[((e[n + 1] & 15) << 2) | (e[n + 2] >> 6)]),
          (o += Me[e[n + 2] & 63]);
      return (
        r % 3 === 2
    ...
    ro = function (t) {
      ...
      for (r = 0; r < n; r += 4)
        (a = We[t.charCodeAt(r)]),
          (s = We[t.charCodeAt(r + 1)]),
          (i = We[t.charCodeAt(r + 2)]),
          (l = We[t.charCodeAt(r + 3)]),
          (u[o++] = (a << 2) | (s >> 4)),
          (u[o++] = ((s & 15) << 4) | (i >> 2)),
          (u[o++] = ((i & 3) << 6) | (l & 63));
      return c;
  ...
  function oo(t, e) {
    let n = hn.get(t);
    return (
      n || ((n = new Map()), hn.set(t, n)), n.has(e) || n.set(e, []), n.get(e)
    );
  }
  const pn = (t, e, n) => {
  ...
  const mn = (t, e, n) => [...t].map((r) => Ye(r, e, n)),
    fn = (t, e) => {
      const n = [
        "WebGLActiveInfo",
        "WebGLBuffer",
  ...
  function yn(t, e, n) {
    ...
    try {
      const o = ge(t.HTMLCanvasElement.prototype, "getContext", function (a) {
        return function (s, ...i) {
          return (
            Q(this, e, n, !0) || "__context" in this || (this.__context = s),
            a.apply(this, [s, ...i])
          );
        };
      });
  ...
  function io(t, e, n, r, o) {
    const a = [];
    return (
      a.push(...gn(e.WebGLRenderingContext.prototype, pe.WebGL, t, n, r, o, e)),
      typeof e.WebGL2RenderingContext < "u" &&
        a.push(
          ...gn(e.WebGL2RenderingContext.prototype, pe.WebGL2, t, n, r, o, e)
        ),
      () => {
        a.forEach((s) => s());
      }
...
`,
      ...
      i = a.substring(s) + (r ? "//# sourceMappingURL=" + r : ""),
  ...
  var uo = co(
    ...
    mo = (t, e) => {
      ...
      if (t != null && vn)
        for (var r of vn(t)) e.indexOf(r) < 0 && po.call(t, r) && (n[r] = t[r]);
      return n;
    },
    fo = (t, e, n) =>
      new Promise((r, o) => {
        var a = (l) => {
          ...
          i = (l) =>
            l.done ? r(l.value) : Promise.resolve(l.value).then(a, s);
  ...
  class yo {
    constructor(e) {
      ...
      (this.mutationCb = e.mutationCb),
        (this.mirror = e.mirror),
        s && n === "all" && this.initCanvasMutationObserver(r, o, a),
        s &&
          typeof n == "number" &&
          this.initCanvasFPSObserver(n, r, o, a, { dataURLOptions: i });
    }
    reset() {
    ...
    initCanvasFPSObserver(e, n, r, o, a) {
      ...
      l.onmessage = (m) => {
        ...
        this.mutationCb({
          ...
          type: pe["2D"],
          commands: [
            { property: "clearRect", args: [0, 0, y, g] },
            {
              property: "drawImage",
              args: [
                {
      ...
      const h = () => {
          const m = [];
          return (
            n.document.querySelectorAll("canvas").forEach((b) => {
              Q(b, r, o, !0) || m.push(b);
            }),
            m
          );
    ...
    initCanvasMutationObserver(e, n, r) {
      ...
      const o = yn(e, n, r),
        a = so(this.processMutation.bind(this), e, n, r),
  ...
  class go {
    ...
    adoptStyleSheets(e, n) {
      ...
      for (const a of e) {
        let s;
        if (this.styleMirror.has(a)) s = this.styleMirror.getId(a);
        else {
          s = this.styleMirror.add(a);
          const i = Array.from(a.rules || CSSRule);
          o.push({
            styleId: s,
            rules: i.map((l, c) => ({ rule: Mt(l), index: c })),
          });
        }
        r.styleIds.push(s);
      }
  ...
  var vo = Object.defineProperty,
    ...
    bn = (t, e, n) =>
      e in t
        ? vo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
        : (t[e] = n),
    se = (t, e) => {
  ...
  function be(t = {}) {
    ...
    V = (I, oe) => {
      var ae;
      if (
        (((ae = Se[0]) == null ? void 0 : ae.isFrozen()) &&
          I.type !== C.FullSnapshot &&
          !(I.type === C.IncrementalSnapshot && I.data.source === N.Mutation) &&
          Se.forEach((B) => B.unfreeze()),
        z)
      )
        e?.(te(I), oe);
      else if (X) {
    ...
    const w = (I) => {
        V(
          G({
            type: C.IncrementalSnapshot,
            data: se({ source: N.Mutation }, I),
          })
        );
      },
      v = (I) =>
        V(
          G({ type: C.IncrementalSnapshot, data: se({ source: N.Scroll }, I) })
        ),
      M = (I) =>
        V(
          G({
            type: C.IncrementalSnapshot,
            data: se({ source: N.CanvasMutation }, I),
          })
        ),
      T = (I) =>
        V(
          G({
            type: C.IncrementalSnapshot,
            data: se({ source: N.AdoptedStyleSheet }, I),
          })
        ),
    ...
    Xe = (I = !1) => {
      ...
      const Ue = Sr(document, {
        ...
        inlineImages: _,
        onSerialize: (re) => {
          Ie(re, le) && ne.addIframe(re),
            ct(re, le) && W.trackLinkElement(re),
            ve(re) && xe.addShadowRoot(re.shadowRoot, document);
        },
        onIframeLoad: (re, It) => {
                ...
                window.pageXOffset !== void 0
                  ...
                  : document?.documentElement.scrollLeft ||
                    ((ae =
                      ...
                      ? void 0
                      : ae.scrollLeft) ||
                    ((B = document?.body) == null ? void 0 : B.scrollLeft) ||
                    0,
              top:
                window.pageYOffset !== void 0
                  ...
                  : document?.documentElement.scrollTop ||
                    ((A =
                      (ue = document?.body) == null
                        ? void 0
                        : ue.parentElement) == null
                      ? void 0
                      : A.scrollTop) ||
                    ((ie = document?.body) == null ? void 0 : ie.scrollTop) ||
                    0,
            },
          },
        })
      ),
        Se.forEach((re) => re.unlock()),
        document.adoptedStyleSheets &&
          document.adoptedStyleSheets.length > 0 &&
          W.adoptStyleSheets(document.adoptedStyleSheets, le.getId(document));
    };
    try {
      const I = [];
      I.push(
        ...
        return Xr(
          {
            ...
            viewportResizeCb: (A) =>
              V(
                G({
                  type: C.IncrementalSnapshot,
                  data: se({ source: N.ViewportResize }, A),
                })
              ),
            inputCb: (A) =>
              V(
            ...
            styleSheetRuleCb: (A) =>
              V(
                G({
                  type: C.IncrementalSnapshot,
                  data: se({ source: N.StyleSheetRule }, A),
                })
              ),
  ...
  const Mo = /-([a-z])/g,
    ko = /^--[a-zA-Z0-9-]+$/,
    ft = (t) =>
      ko.test(t) ? t : t.replace(Mo, (e, n) => (n ? n.toUpperCase() : "")),
    Do = /\B([A-Z])/g,
  ...
  class ce {
    constructor(...e) {
      (this.childNodes = []),
        ...
        (this.ELEMENT_NODE = U.ELEMENT_NODE),
        (this.TEXT_NODE = U.TEXT_NODE);
    }
    get firstChild() {
  ...
  function xo(t) {
    return class Zn extends t {
      constructor() {
        super(...arguments),
          (this.nodeType = U.DOCUMENT_NODE),
          (this.nodeName = "#document"),
          (this.compatMode = "CSS1Compat"),
          (this.RRNodeType = R.Document),
          (this.textContent = null);
      }
      get documentElement() {
        return (
          this.childNodes.find(
            (n) => n.RRNodeType === R.Element && n.tagName === "HTML"
          ) || null
        );
      }
      get body() {
        ...
        return (
          ((n = this.documentElement) === null || n === void 0
            ? void 0
            : n.childNodes.find(
                (r) => r.RRNodeType === R.Element && r.tagName === "BODY"
              )) || null
        );
      }
      get head() {
        ...
        return (
          ((n = this.documentElement) === null || n === void 0
            ? void 0
            : n.childNodes.find(
                (r) => r.RRNodeType === R.Element && r.tagName === "HEAD"
              )) || null
        );
      }
      get implementation() {
      ...
      appendChild(n) {
        ...
        if (
          (r === R.Element || r === R.DocumentType) &&
          this.childNodes.some((o) => o.RRNodeType === r)
        )
          throw new Error(
            `RRDomException: Failed to execute 'appendChild' on 'RRNode': Only one ${
              r === R.Element ? "RRElement" : "RRDoctype"
  ...
  function En(t) {
    return class extends t {
      constructor(e, n, r) {
        super(),
          (this.nodeType = U.DOCUMENT_TYPE_NODE),
          (this.RRNodeType = R.DocumentType),
          (this.textContent = null),
          (this.name = e),
          (this.publicId = n),
          (this.systemId = r),
  ...
  function Nn(t) {
    return class extends t {
      constructor(e) {
        super(),
          (this.nodeType = U.ELEMENT_NODE),
          (this.RRNodeType = R.Element),
          (this.attributes = {}),
      ...
      get style() {
        const e = this.attributes.style ? To(this.attributes.style) : {},
          n = /\B([A-Z])/g;
        return (
          (e.setProperty = (r, o, a) => {
            if (n.test(r)) return;
            const s = ft(r);
            o ? (e[s] = o) : delete e[s],
              a === "important" && (e[s] += " !important"),
              (this.attributes.style = wn(e));
          }),
          (e.removeProperty = (r) => {
            if (n.test(r)) return "";
            const o = ft(r),
  ...
  function In(t) {
    return class extends t {
      constructor(e) {
        super(),
          (this.nodeType = U.COMMENT_NODE),
          (this.nodeName = "#comment"),
          (this.RRNodeType = R.Comment),
          (this.data = e);
      }
      get textContent() {
        return this.data;
    ...
    return class extends t {
      constructor(e) {
        super(),
          ...
          (this.nodeType = U.CDATA_SECTION_NODE),
          (this.RRNodeType = R.CDATA),
          (this.data = e);
      }
      get textContent() {
        return this.data;
  ...
  function de(t, e, n, r) {
    const o = t.childNodes,
      a = e.childNodes;
    (r = r || e.mirror || e.ownerDocument.mirror),
      (o.length > 0 || a.length > 0) && Mn(Array.from(o), a, t, n, r);
    let s = null,
      i = null;
    switch (e.RRNodeType) {
      case R.Document: {
      ...
      case R.Element: {
        const l = t,
          c = e;
        switch (
          (_o(l, c, r), (i = c.scrollData), (s = c.inputData), c.tagName)
        ) {
          case "AUDIO":
          case "VIDEO": {
            const u = t,
            ...
            d.paused !== void 0 && (d.paused ? u.pause() : u.play()),
              ...
              d.currentTime !== void 0 && (u.currentTime = d.currentTime),
              d.playbackRate !== void 0 && (u.playbackRate = d.playbackRate);
            break;
          }
          case "CANVAS":
            {
              ...
              u.canvasMutations.forEach((d) =>
                n.applyCanvas(d.event, d.mutation, t)
              );
            }
            break;
          case "STYLE":
        ...
        if (c.shadowRoot) {
          ...
          (u.length > 0 || d.length > 0) &&
            Mn(Array.from(u), d, l.shadowRoot, n, r);
        }
        break;
      }
      case R.Text:
    ...
    if (
      (i && n.applyScroll(i, !0), s && n.applyInput(s), e.nodeName === "IFRAME")
    ) {
      const l = t.contentDocument,
        c = e;
      if (l) {
        const u = r.getMeta(c.contentDocument);
        u && n.mirror.add(l, Object.assign({}, u)),
          de(l, c.contentDocument, n, r);
      }
    }
  }
  function _o(t, e, n) {
    ...
    for (const a in o) {
      const s = o[a],
        i = n.getMeta(e);
      if (i && "isSVG" in i && i.isSVG && yt[a]) t.setAttributeNS(yt[a], a, s);
  ...
  function Mn(t, e, n, r, o) {
    ...
    let s = 0,
      ...
      b;
    for (; s <= i && l <= c; ) {
      const S = r.mirror.getId(u),
        f = r.mirror.getId(d),
        y = o.getId(h),
        g = o.getId(p);
      if (u === void 0) u = t[++s];
      else if (d === void 0) d = t[--i];
      else if (S !== -1 && S === y) de(u, h, r, o), (u = t[++s]), (h = e[++l]);
      else if (f !== -1 && f === g) de(d, p, r, o), (d = t[--i]), (p = e[--c]);
      else if (S !== -1 && S === g)
        n.insertBefore(u, d.nextSibling),
          de(u, p, r, o),
          (u = t[++s]),
          (p = e[--c]);
      else if (f !== -1 && f === y)
        n.insertBefore(d, u), de(d, h, r, o), (d = t[--i]), (h = e[++l]);
      else {
        if (!m) {
          m = {};
          for (let E = s; E <= i; E++) {
        ...
        if (((b = m[o.getId(h)]), b)) {
          ...
          n.nodeName === "#document" &&
            ((a = r.mirror.getMeta(E)) === null || a === void 0
              ? void 0
              : a.type) === R.Element &&
            n.documentElement &&
            (n.removeChild(n.documentElement), (t[s] = void 0), (u = void 0)),
            n.insertBefore(E, u || null),
            de(E, h, r, o);
        }
        h = e[++l];
      }
      ...
      case R.Element: {
        ...
        (s = Ao[s] || s),
          o && "isSVG" in o && o?.isSVG
            ? (a = document.createElementNS(yt.svg, s))
  ...
  function kn(t, e, n, r) {
    ...
    return (
      e instanceof ke &&
        (a || ((a = Dn(o, e.unserializedId)), n.add(t, a)),
  ...
  function zo(t, e = Io(), n = new ke()) {
    function r(o, a) {
      ...
      if (s !== null)
        if (
          (a?.nodeName !== "IFRAME" &&
            o.nodeType !== U.DOCUMENT_FRAGMENT_NODE &&
            (a?.appendChild(s), (s.parentNode = a), (s.parentElement = a)),
          o.nodeName === "IFRAME")
        ) {
          const i = o.contentDocument;
          i && r(i, s);
        } else
          (o.nodeType === U.DOCUMENT_NODE ||
            o.nodeType === U.ELEMENT_NODE ||
            o.nodeType === U.DOCUMENT_FRAGMENT_NODE) &&
            (o.nodeType === U.ELEMENT_NODE &&
              o.shadowRoot &&
              r(o.shadowRoot, s),
            o.childNodes.forEach((i) => r(i, s)));
    }
    return r(t, null), n;
  }
  function Ho() {
  ...
  function Zo(t = window, e = document) {
    ...
    function b(f) {
      ...
      (x = x > 1 ? 1 : x),
        (g = c(x)),
        (E = f.startX + (f.x - f.startX) * g),
        (k = f.startY + (f.y - f.startY) * g),
        f.method.call(f.scrollable, E, k),
        (E !== f.x || k !== f.y) && t.requestAnimationFrame(b.bind(t, f));
    }
    function S(f, y, g) {
      let E, k, x, F;
      const _ = a();
      f === e.body
        ? ((E = t),
          (k = t.scrollX || t.pageXOffset),
          (x = t.scrollY || t.pageYOffset),
          (F = o.scroll))
        : ((E = f), (k = f.scrollLeft), (x = f.scrollTop), (F = l)),
        b({
          scrollable: E,
          method: F,
          startTime: _,
    ...
    (t.scroll = t.scrollTo =
      ...
      (n.prototype.scroll = n.prototype.scrollTo =
        function () {
          ...
          const f = arguments[0].left,
            y = arguments[0].top;
          S.call(
            this,
            this,
            typeof f > "u" ? this.scrollLeft : ~~f,
      ...
      (n.prototype.scrollIntoView = function () {
        ...
        f !== e.body
          ? (S.call(
              this,
              f,
              f.scrollLeft + g.left - y.left,
              f.scrollTop + g.top - y.top
            ),
            t.getComputedStyle(f).position !== "fixed" &&
              t.scrollBy({ left: y.left, top: y.top, behavior: "smooth" }))
  ...
  class Ko {
    ...
    start() {
      ...
      const n = () => {
        ...
        for (
          this.timeOffset += (r - e) * this.speed, e = r;
          this.actions.length;

        ) {
          const o = this.actions[0];
          if (this.timeOffset >= o.delay) this.actions.shift(), o.doAction();
          else break;
        }
  ...
  function xn(t, e) {
    if (
      t.type === C.IncrementalSnapshot &&
      t.data.source === N.MouseMove &&
      t.data.positions &&
        ...
        if (a.type === "xstate.assign") {
          ...
          return (
            typeof a.assignment == "function"
              ? (s = a.assignment(r, n))
              : Object.keys(a.assignment).forEach(function (i) {
                  s[i] =
                    typeof a.assignment[i] == "function"
                      ? a.assignment[i](r, n)
                      : a.assignment[i];
                }),
            (r = s),
  ...
  function Wn(t, e) {
    ...
    var n = On(
        Pn(
          vt(t.states[t.initial].entry).map(function (s) {
      ...
      a = {
        ...
        initialState: {
          ...
          actions: r,
          context: o,
          matches: Ke(t.initial),
        },
        transition: function (s, i) {
          var l,
            c,
            u = typeof s == "string" ? { value: s, context: t.context } : s,
            d = u.value,
            h = u.context,
            p = _n(i),
            m = t.states[d];
          if (m.on) {
            ...
            try {
              for (
                ...
                var g = typeof y == "string" ? { target: y } : y,
                  E = g.target,
                  k = g.actions,
                  x = k === void 0 ? [] : k,
                  F = g.cond,
                ...
                if (_(h, p)) {
                  var z = On(
                      Pn(
                        (J
                          ? vt(x)
                          : [].concat(m.exit, x, q.entry).filter(function (L) {
                              return L;
                            })
                        ).map(function (L) {
  ...
  var Qo = Object.defineProperty,
    ...
    Bn = (t, e, n) =>
      e in t
        ? Qo(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
        : (t[e] = n),
    St = (t, e) => {
    ...
    const o = Wn(
      ...
      },
      {
        actions: {
          castEvent: Re({
            lastPlayedEvent: (a, s) =>
              s.type === "CAST_EVENT" ? s.payload.event : a.lastPlayedEvent,
          }),
          ...
          play(a) {
            ...
            const d = ns(l, c);
            let h = u?.timestamp;
            u?.type === C.IncrementalSnapshot &&
              u.data.source === N.MouseMove &&
              (h =
                u.timestamp +
                ((s = u.data.positions[0]) == null ? void 0 : s.timeOffset)),
              c < (h || 0) && r.emit(O.PlayBack);
            const p = new Array();
            for (const m of d)
              if (!(h && h < c && (m.timestamp <= h || m === u)))
                if (m.timestamp < c) p.push(m);
                else {
                  const b = e(m, !1);
                  i.addAction({
                    doAction: () => {
          ...
          resetLastPlayedEvent: Re((a) =>
            bt(St({}, a), { lastPlayedEvent: null })
          ),
          startLive: Re({
            baselineTime: (a, s) => (
              a.timer.toggleLiveMode(!0),
              a.timer.start(),
    ...
    const e = Wn(
      ...
      },
      {
        actions: {
          ...
          recordSpeed: Re({ normalSpeed: (n) => n.timer.speed }),
          restoreSpeed: (n) => {
  ...
  function jn(t, e) {
    let n = Gn.get(t);
    return (
      n || ((n = new Map()), Gn.set(t, n)), n.has(e) || n.set(e, []), n.get(e)
    );
  }
  function ye(t, e, n) {
    return (r) =>
    ...
    return as(
      ...
      function* ({
        ...
        try {
          ...
          const i = s[e.property],
            l = yield Promise.all(e.args.map(ye(o, s))),
            c = i.apply(s, l);
          us(s, c);
        } catch (s) {
          a(e, s);
  ...
  var fs = Object.defineProperty,
    ...
    Yn = (t, e, n) =>
      e in t
        ? fs(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
        : (t[e] = n),
    Qe = (t, e) => {
  ...
  function Xn(t) {
    return (
      t.type == C.IncrementalSnapshot &&
      (t.data.source == N.TouchMove ||
        (t.data.source == N.MouseInteraction && t.data.type == j.TouchStart))
    );
  }
  class Ns {
    constructor(e, n) {
      if (
        ...
        (this.handleResize = (i) => {
          ...
          for (const l of [this.mouseTail, this.iframe])
            !l ||
              (l.setAttribute("width", String(i.width)),
              l.setAttribute("height", String(i.height)));
        }),
        ...
        (this.getCastFn = (i, l = !1) => {
          ...
          switch (i.type) {
            ...
            case C.FullSnapshot:
              c = () => {
                ...
                this.rebuildFullSnapshot(i, l),
                  (u = this.iframe.contentWindow) == null ||
                    u.scrollTo(i.data.initialOffset),
            ...
            case C.IncrementalSnapshot:
              c = () => {
                if (
                  (this.applyIncremental(i, l),
                  !l &&
                    (i === this.nextUserInteractionEvent &&
                  ...
                  for (const u of this.service.state.context.events)
                    if (
                      ...
                      u.delay - i.delay >
                        bs * this.speedService.state.context.timer.speed &&
          ...
          return () => {
            ...
            for (const d of this.config.plugins || [])
              d.handler && d.handler(i, l, { replayer: this });
            ...
            if (i === this.service.state.context.events[u]) {
              const d = () => {
                u < this.service.state.context.events.length - 1 ||
                  ...
                  this.emitter.emit(O.Finish));
              };
              i.type === C.IncrementalSnapshot &&
              i.data.source === N.MouseMove &&
              i.data.positions.length
                ? setTimeout(() => {
                    d();
                  }, Math.max(0, -i.data.positions[0].timeOffset + 50))
                : d();
            }
      ...
      (this.config = Object.assign({}, r, n)),
        ...
        this.emitter.on(O.Resize, this.handleResize),
        this.setupDom();
      for (const i of this.config.plugins || [])
        i.getMirror && i.getMirror({ nodeMirror: this.mirror });
        ...
        if (this.usingVirtualDom) {
          const i = {
            ...
            applyStyleSheetMutation: (l, c) => {
              l.source === N.StyleSheetRule
                ? this.applyStyleSheetRule(l, c)
                : l.source === N.StyleDeclaration &&
      ...
      (this.service = rs(
        {
          events: e
            .map((i) => (n && n.unpackFn ? n.unpackFn(i) : i))
            .sort((i, l) => i.timestamp - l.timestamp),
          timer: o,
          timeOffset: 0,
          baselineTime: 0,
        ...
        this.service.start(),
        this.service.subscribe((i) => {
          this.emitter.emit(O.StateChange, { player: i });
        }),
        (this.speedService = os({ normalSpeed: -1, timer: o })),
        this.speedService.start(),
        this.speedService.subscribe((i) => {
        ...
        setTimeout(() => {
          ...
          this.firstFullSnapshot ||
            ...
            (i = this.iframe.contentWindow) == null ||
              i.scrollTo(s.data.initialOffset));
        }, 1),
        this.service.state.context.events.find(Xn) &&
    ...
    resume(e = 0) {
      console.warn(
        ...
        this.play(e),
        this.emitter.emit(O.Resume);
    }
    destroy() {
      this.pause(),
        this.config.root.removeChild(this.wrapper),
        this.emitter.emit(O.Destroy);
    }
    startLive(e) {
    ...
    addEvent(e) {
      ...
      Xn(n) && this.mouse.classList.add("touch-device"),
    ...
    setupDom() {
      ...
      this.config.UNSAFE_replayCanvas && e.push("allow-scripts"),
        ...
        this.iframe.contentWindow &&
          this.iframe.contentDocument &&
          (Zo(this.iframe.contentWindow, this.iframe.contentDocument),
          at(this.iframe.contentWindow));
    }
    rebuildFullSnapshot(e, n = !1) {
      ...
      const r = [],
        o = (i, l) => {
          ...
          for (const c of this.config.plugins || [])
            c.onBuild && c.onBuild(i, { id: l, replayer: this });
        };
      Mr(e.data.node, {
      ...
      for (const { mutationInQueue: i, builtNode: l } of r)
        this.attachDocumentToIframe(i, l),
          (this.newDocumentQueue = this.newDocumentQueue.filter(
            (c) => c !== i
          ));
      const { documentElement: a, head: s } = this.iframe.contentDocument;
      this.insertStyleRules(a, s),
        this.service.state.matches("playing") ||
          this.iframe.contentDocument
            .getElementsByTagName("html")[0]
            .classList.add("rrweb-paused"),
        this.emitter.emit(O.FullsnapshotRebuilded, e),
    ...
    insertStyleRules(e, n) {
      ...
      if (
        ...
        this.virtualDom.mirror.add(a, Dn(a, this.virtualDom.unserializedId)),
          e.insertBefore(a, n),
          a.rules.push({
        ...
        for (let s = 0; s < o.length; s++)
          (r = a.sheet) == null || r.insertRule(o[s], s);
      }
    }
    attachDocumentToIframe(e, n) {
      const r = this.usingVirtualDom ? this.virtualDom.mirror : this.mirror,
        ...
        a = (s, i) => {
          ...
          for (const c of this.config.plugins || [])
            c.onBuild && c.onBuild(s, { id: i, replayer: this });
        };
      _e(e.node, {
      ...
      for (const { mutationInQueue: s, builtNode: i } of o)
        this.attachDocumentToIframe(s, i),
          (this.newDocumentQueue = this.newDocumentQueue.filter(
            (l) => l !== s
          ));
    }
    ...
    waitForStylesheetLoad() {
      ...
      if (n) {
        ...
        n.querySelectorAll('link[rel="stylesheet"]').forEach((l) => {
            ...
            l.addEventListener("load", () => {
              r.delete(l),
                r.size === 0 &&
                  ...
                  this.emitter.emit(O.LoadStylesheetEnd),
                  o && clearTimeout(o),
                  i());
            }));
        }),
          r.size > 0 &&
            (this.service.send({ type: "PAUSE" }),
            this.emitter.emit(O.LoadStylesheetStart),
            (o = setTimeout(() => {
              a.matches("playing") && this.play(this.getCurrentTime()),
                (o = -1),
                i();
    ...
    preloadAllImages() {
      return Et(this, null, function* () {
        ...
        for (const r of this.service.state.context.events)
          r.type === C.IncrementalSnapshot &&
            r.data.source === N.CanvasMutation &&
      ...
      return Et(this, null, function* () {
        if (!this.canvasEventMap.has(n)) {
          ...
          if ("commands" in e) {
              ...
              e.commands.map((a) =>
                Et(this, null, function* () {
                  const s = yield Promise.all(
                    a.args.map(ye(this.imageMap, null, r))
                  );
            ...
            r.isUnchanged === !1 &&
              this.canvasEventMap.set(n, wt(Qe({}, e), { commands: o }));
          } else {
            const o = yield Promise.all(e.args.map(ye(this.imageMap, null, r)));
            r.isUnchanged === !1 &&
              this.canvasEventMap.set(n, wt(Qe({}, e), { args: o }));
          }
        }
      });
    }
    applyIncremental(e, n) {
      ...
      switch (s.source) {
          ...
          if (n) {
            ...
            s.positions.forEach((i) => {
              ...
              this.timer.addAction({
                ...
                delay:
                  e.delay -
                  ((r = s.positions[0]) == null ? void 0 : r.timeOffset),
              });
          break;
        case N.MouseInteraction: {
          if (s.id === -1 || n) break;
          const i = new Event(j[s.type].toLowerCase()),
          ...
          switch (s.type) {
            ...
            case j.TouchEnd:
              n
                ? (s.type === j.TouchStart
                    ? (this.touchActive = !0)
                    : s.type === j.TouchEnd && (this.touchActive = !1),
                  (this.mousePos = { x: s.x, y: s.y, id: s.id, debugData: s }))
                : (s.type === j.TouchStart && (this.tailPositions.length = 0),
        ...
        case N.MediaInteraction: {
          const i = this.usingVirtualDom
            ? this.virtualDom.mirror.getNode(s.id)
            : this.mirror.getNode(s.id);
          if (!i) return this.debugNodeNotFound(s, s.id);
          const l = i;
          try {
            s.currentTime && (l.currentTime = s.currentTime),
              s.volume && (l.volume = s.volume),
              s.muted && (l.muted = s.muted),
              s.type === me.Pause && l.pause(),
              s.type === me.Play && l.play(),
              s.type === me.RateChange && (l.playbackRate = s.playbackRate);
          } catch (c) {
        ...
        case N.StyleDeclaration: {
          this.usingVirtualDom
            ? s.styleId
              ...
              : s.id &&
                ((o = this.virtualDom.mirror.getNode(s.id)) == null ||
                  o.rules.push(s))
    ...
    applyMutation(e, n) {
      if (
        ...
        zo(this.iframe.contentDocument, this.mirror, this.virtualDom),
        Object.keys(this.legacy_missingNodeRetryMap).length)
      )
        for (const c in this.legacy_missingNodeRetryMap)
          try {
            const u = this.legacy_missingNodeRetryMap[c],
              d = kn(u.node, this.virtualDom, this.mirror);
            d && (u.node = d);
          } catch (u) {
      ...
      const o = Qe({}, this.legacy_missingNodeRetryMap),
        a = [],
        s = (c) => {
          let u = null;
          return (
        ...
        i = (c) => {
          ...
          if (!d)
            return c.node.type === D.Document
              ? this.newDocumentQueue.push(c)
              : a.push(c);
          c.node.isShadow &&
            (ve(d) || d.attachShadow({ mode: "open" }), (d = d.shadowRoot));
          let h = null,
            p = null;
          if (
            (c.previousId && (h = r.getNode(c.previousId)),
            c.nextId && (p = r.getNode(c.nextId)),
            s(c))
          )
            return a.push(c);
          if (c.node.rootId && !r.getNode(c.node.rootId)) return;
          const m = c.node.rootId
          ...
          const b = (y, g) => {
              for (const E of this.config.plugins || [])
                E.onBuild && E.onBuild(y, { id: g, replayer: this });
            },
            S = _e(c.node, {
              doc: m,
              mirror: r,
          ...
          if (
            ...
            const y = Array.isArray(d.childNodes)
              ? d.childNodes
          ...
          if (h && h.nextSibling && h.nextSibling.parentNode)
            d.insertBefore(S, h.nextSibling);
          else if (p && p.parentNode)
            d.contains(p) ? d.insertBefore(S, p) : d.insertBefore(S, null);
          else {
          ...
          if (
            ...
            this.usingVirtualDom &&
              S.nodeName === "#text" &&
              d.nodeName === "STYLE" &&
              ((u = d.rules) == null ? void 0 : u.length) > 0 &&
              (d.rules = []),
            Ie(S, this.mirror))
          ) {
            const y = this.mirror.getId(S),
              g = this.newDocumentQueue.find((E) => E.parentId === y);
            g &&
              (this.attachDocumentToIframe(g, S),
              (this.newDocumentQueue = this.newDocumentQueue.filter(
                (E) => E !== g
              )));
          }
          (c.previousId || c.nextId) &&
            this.legacy_resolveMissingNode(o, d, S, c);
        };
      e.adds.forEach((c) => {
        i(c);
      });
            ...
            if (typeof d == "string") {
              ...
              if (h === null) u.removeAttribute(d);
                ...
                const p = h,
                  m = u;
                for (const b in p)
                  if (p[b] === !1) m.style.removeProperty(b);
                  else if (p[b] instanceof Array) {
                    const S = p[b];
    ...
    applySelection(e) {
      try {
        const n = new Set(),
          r = e.ranges.map(
            ({ start: o, startOffset: a, end: s, endOffset: i }) => {
      ...
      e.styleId
        ...
        : e.id &&
          (r =
            ...
            null),
        r &&
          (e.source === N.StyleSheetRule
            ? this.applyStyleSheetRule(e, r)
            : e.source === N.StyleDeclaration &&
    ...
    applyStyleDeclaration(e, n) {
      e.set &&
        Te(n.rules, e.index).style.setProperty(
          e.set.property,
          e.set.value,
          e.set.priority
        ),
        e.remove &&
          Te(n.rules, e.index).style.removeProperty(e.remove.property);
    }
    applyAdoptedStyleSheet(e) {
          ...
          if (
            ...
            try {
              (c = new u.CSSStyleSheet()),
                this.styleMirror.add(c, i.styleId),
                this.applyStyleSheetRule(
                  { source: N.StyleSheetRule, adds: i.rules },
                  c
                );
            } catch {}
        });
      ...
      const s = (i, l) => {
        const c = l
          ...
          .filter((u) => u !== null);
        ve(i)
          ? (i.shadowRoot.adoptedStyleSheets = c)
          : i.nodeName === "#document" && (i.adoptedStyleSheets = c),
          c.length !== l.length &&
            a < o &&
            (setTimeout(() => s(i, l), 0 + 100 * a), a++);
      };
      s(r, e.styleIds);
    }
    legacy_resolveMissingNode(e, n, r, o) {
      const { previousId: a, nextId: s } = o,
        i = a && e[a],
        l = s && e[s];
      if (i) {
    ...
    moveAndHover(e, n, r, o, a) {
      ...
      const i = ut(s, this.iframe),
        l = e * i.absoluteScale + i.x,
        c = n * i.absoluteScale + i.y;
    ...
    drawMouseTail(e) {
      ...
      const {
          ...
          ? Ct
          : Object.assign({}, Ct, this.config.mouseTail),
        s = () => {
          if (!this.mouseTail) return;
          const i = this.mouseTail.getContext("2d");
          !i ||
            !this.tailPositions.length ||
            (i.clearRect(0, 0, this.mouseTail.width, this.mouseTail.height),
            i.beginPath(),
            (i.lineWidth = r),
            (i.lineCap = n),
            (i.strokeStyle = o),
            i.moveTo(this.tailPositions[0].x, this.tailPositions[0].y),
            this.tailPositions.forEach((l) => i.lineTo(l.x, l.y)),
            i.stroke());
        };
    ...
    isUserInteraction(e) {
      return e.type !== C.IncrementalSnapshot
        ? !1
        : e.data.source > N.Mutation && e.data.source <= N.Input;
    }
    backToNormal() {
      (this.nextUserInteractionEvent = null),
        !this.speedService.state.matches("normal") &&
          (this.speedService.send({ type: "BACK_TO_NORMAL" }),
          this.emitter.emit(O.SkipEnd, {
  ...
  const { addCustomEvent: Cs } = be,
    { freezePage: Is } = be;
  return (
    (ee.EventType = C),
    (ee.IncrementalSource = N),
    (ee.MouseInteractions = j),
    (ee.Replayer = Ns),
    (ee.ReplayerEvents = O),
    (ee.addCustomEvent = Cs),
    (ee.freezePage = Is),
    (ee.record = be),
    (ee.utils = kr),
...
//     setInterval(() => {
//       if (events.length > 0) {
//         fetch(endpoint || "https://session-recording.mfilterit.org/api/sessions/save-recording?sc=nigeria", {
//           method: 'POST',
//           headers: {
...
//           body: JSON.stringify({
//             id1,
//             id2: Date.now(), // Always use current timestamp
//             pgid,
//             events,
//           }),
...
//           endpoint || "https://session-recording.mfilterit.org/api/sessions/save-recording?sc=nigeria",
//           JSON.stringify({
//             id1,
//             id2: Date.now(), // Always use current timestamp
//             pgid,
...
//   if (currentScript) {
//     init({
//       id1: currentScript.dataset.id1,
//       id2: Date.now(), // Initial id2 value
//       pgid: currentScript.dataset.pgid,
...
(function () {
  function init({
    ...
    const url =
      endpoint || "https://session-recording.mfilterit.net/api/sessions/save-recording?sc=nigeria";

    async function sendLoop() {
      while (true) {
        if (!sending && events.length > 0) {
          sending = true;
          ...
          try {
            ...
            events.splice(0, payload.events.length);
          } catch (error) {
